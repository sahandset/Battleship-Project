...
public class SpaceMap extends Map{
    ...
    /**
     * SpaceMap() Constructor for SpaceMap Object
     */
    public SpaceMap() {
    ...
    /**
     * Returns the name of the SpaceMap
     * @return name of SpaceMap
     */
    ...
    /**
     * Validates that Ship is of type Orbitable (only Orbitable ships can be deployed on SpaceMap)
     * @param ship Ship Object whose deployment on a certain Map is to be validated
     * @return true if the ship is an instance of an appropriate type for the SpaceMap, else false
     */
    ...
    /**
     * Places a Narwhal on the Map (can't be placed on SpaceMap)
     */
    public void placeNarwhal() {
        System.out.println("Cannot place a narwhal on SpaceMap");
    }

    /**
     * Places a Jaws on the Map (can't be placed on SpaceMap)
     */
    public void placeJaws() {
        System.out.println("Cannot place a jaws on SpaceMap");
    }
